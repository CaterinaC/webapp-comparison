...
dt <- fread("/home/caterina/Documents/TalksJune2020Onwards/ShinyVsPythonCompetitors/code/webapp-comparison/ShinyR/data/NEED_data_explorer_2021.csv",
            na.strings = "n/a")
...
server <- function(input, output, session) {
  ...
  selectedData <- reactive({
    ...
    dt_chunk <- melt(dt_chunk, id.vars = c("Attribute 1", "Attribute 2"))
    dt_chunk[ , variable := gsub("Gas Median |Elec Median", "", variable) %>% as.numeric()]
